...
class TrafficSignProcessor:
    ...
    def __init__(self, config=None):
        ...
        self.config = {
            ...
            # TODO 1: Map original dataset labels -> 0–4 classes
            ...
            'class_mapping': {
                ...
                34: 2,   # Turn left
                35: 3,   # Ahead only
                40: 4    # Roundabout mandatory
            },

            # TODO 2: Input image size for ResNet
    ...
    def create_datasets(self, augment_train=True, include_original=False):
        ...
        if augment_train:
            ...
            # TODO 3: Data Augmentation(improves generalisation)
