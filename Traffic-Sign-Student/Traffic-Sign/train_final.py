...
def train(model, train_loader, optimizer, criterion, epoch, epochs):
    ...
    for batch_idx, (inputs, targets) in enumerate(pbar):
        ...
        # Statistics
        # TODO 5 & 6: Calculate training loss and accuracy
...
def main():
    ...
    parser.add_argument('--plot-dir', default='results', type=str, help='Directory to save training plots (PNG)')
    ...
    test_results = vis_utils.plot_confusion_matrix(
        model, test_loader, processor.class_names, device, criterion, plot_dir=args.plot_dir
    )
    
    # Visualize results
    vis_utils.visualize_training_results(
        train_loss_list, train_acc_list, val_loss_list, val_acc_list,
        best_acc, args.optimizer, args.lr, args.batch_size, args.scheduler, plot_dir=args.plot_dir
    )
    
    # Visualize predictions
    vis_utils.visualize_predictions(model, test_loader, processor.class_names, device, plot_dir=args.plot_dir)
